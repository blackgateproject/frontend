...
import TestParallel from "./pages/test/TestParallel";
import TestSequential from "./pages/test/TestSequential";
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Test Routes */}
        <Route path="/test">
          <Route path="serial" element={<TestSequential role={"test"} />} />
