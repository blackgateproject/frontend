       ...
       <div className="col-span-12">
         ...
         <div className="flex justify-between items-center mb-6">
           ...
           <div className="flex items-center space-x-4">
             <button className="btn bg-purple-700 hover:bg-purple-800 text-white rounded-2xl px-4" onClick={() => navigate('/admin/adduser')}>+ Add User</button>
         ...
         <div className="grid grid-cols-2 gap-4">
           ...
           {users.map((user, index) => (
             <div key={index} className="bg-white rounded-2xl shadow-md p-6 flex justify-between items-center">
               <div className="flex items-center space-x-2">
                 {/* Online/Offline Indicator */}
                 <h2 className="text-lg font-semibold text-[#333333]">
                   {user.firstName} {user.lastName}
                 </h2>
                 <div className={`w-3 h-3 rounded-full ${user.online ? 'bg-purple-600' : 'bg-gray-400'}`}></div>
               </div>
